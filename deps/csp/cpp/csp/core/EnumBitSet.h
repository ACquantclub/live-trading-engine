...
class EnumBitSet {
  ...
  public:
    ...
    bool isSet(EnumT e) const {
        return m_bitset & enumBit(e);
    }
    void reset() {
        m_bitset = 0;
    }
    ...
    size_t size() const {
        return __builtin_popcountl(m_bitset);
    }
    ...
    constexpr EnumBitSet operator|(typename EnumT::EnumV v) const {
        return EnumBitSet(m_bitset | enumBit(v));
    }
    constexpr EnumBitSet operator|(EnumT e) const {
        return EnumBitSet(m_bitset | enumBit(e));
    }
    constexpr EnumBitSet operator|(const EnumBitSet& rhs) const {
        return EnumBitSet(m_bitset | rhs.m_bitset);
    }
    constexpr EnumBitSet operator&(typename EnumT::EnumV v) const {
        return EnumBitSet(m_bitset & enumBit(v));
    }
    ...
    struct iterator {
        ...
        EnumT operator*() const {
            return (EnumT)__builtin_ctzl(m_bitset);
        }  // returns lowest order bit
        iterator operator++() {
            m_bitset &= (m_bitset - 1);
            return *this;
    ...
    iterator begin() const {
        return iterator(m_bitset);
    }
    iterator end() const {
        return iterator(0);
    }

    value_type rawBitSet() const {
        return m_bitset;
    }

    void setRawBitSet(value_type bitset) {
        m_bitset = bitset;
    }
