...
// XXXXXX
// This Code was taken from glibc time/offtime.c, the reason being that gmtime_r actually calls the
// global tzlock (even though technically we dont need tz here ).  This makes it lockless
