...
class DLL_LOCAL InitHelper {
  public:
    ...
    static InitCallback typeInitCallback(PyTypeObject* pyType, std::string name,
                                         PyTypeObject* baseType = nullptr);
    static InitCallback moduleMethodsCallback(PyMethodDef* methods);
    static InitCallback moduleMethod(const char* name, PyCFunction func, int flags,
                                     const char* doc);
...
inline InitHelper::InitCallback InitHelper::moduleMethod(const char* name, PyCFunction func,
