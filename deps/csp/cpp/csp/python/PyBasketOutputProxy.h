...
class PyListBasketOutputProxy final : public PyBaseBasketOutputProxy {
  public:
    ...
    static PyListBasketOutputProxy* create(PyObject* pyType, Node* node, INOUT_ID_TYPE id,
                                           size_t shape);
...
class PyDictBasketOutputProxy : public PyBaseBasketOutputProxy {
  public:
    ...
    static PyDictBasketOutputProxy* create(PyObject* pyType, Node* node, INOUT_ID_TYPE id,
                                           PyObject* shape);
