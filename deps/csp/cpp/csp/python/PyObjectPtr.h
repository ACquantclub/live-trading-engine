...
class PyPtr {
  public:
    ...
    bool operator==(const PyPtr& rhs) const {
        return generic_compare(rhs, Py_EQ);
    }

    bool operator<(const PyPtr& rhs) const {
        return generic_compare(rhs, Py_LT);
    }

    bool operator>(const PyPtr& rhs) const {
        return generic_compare(rhs, Py_GT);
    }
    ...
    PYOBJECT_T* get() const {
        return m_obj;
    }
    PYOBJECT_T* ptr() const {
        return m_obj;
    }
    PYOBJECT_T* operator->() const {
        return m_obj;
    }
    ...
    static PyPtr own(PYOBJECT_T* o) {
        return PyPtr((PyObjectOwn*)o);
    }
    static PyPtr incref(PYOBJECT_T* o) {
        return PyPtr(o);
    }
