...
class PyOutputAdapter : public OutputAdapter {
  public:
    PyOutputAdapter(Engine* engine, PyObjectPtr pyadapter)
        : OutputAdapter(engine), m_pyadapter(pyadapter) {
    }
...
static OutputAdapter* pyoutputadapter_creator(csp::AdapterManager* manager, PyEngine* pyengine,
                                              PyObject* args) {
