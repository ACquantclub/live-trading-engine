...
struct PyIterator : public PyObject {
    ...
    static PyObject* static_iternext(PyIterator* pyiter) {
        return pyiter->m_pyiter.iternext();
    }
...
template <typename ITER_IMPL>
bool PyIterator<ITER_IMPL>::s_typeRegister = InitHelper::instance().registerCallback(
