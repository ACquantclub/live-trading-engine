...
PyObject* PyInputAdapterWrapper::createAdapter(Creator creator, PyObject* args) {
    ...
    if (!PyArg_ParseTuple(args, "OO!OiO!", &pyAdapterManager, &PyEngine::PyType, &pyEngine, &pyType,
                          &pushmode, &PyTuple_Type, &pyArgs))
...
PyObject* PyInputAdapterWrapper::create(InputAdapter* adapter) {
    CSP_BEGIN_METHOD;
    PyInputAdapterWrapper* object = (PyInputAdapterWrapper*)PyInputAdapterWrapper::PyType.tp_alloc(
        &PyInputAdapterWrapper::PyType, 0);
