...
static InputAdapter* create_kafka_input_adapter(csp::AdapterManager* manager, PyEngine* pyengine,
...
static PyModuleDef _kafkaadapterimpl_module = {PyModuleDef_HEAD_INIT,
                                               "_kafkaadapterimpl",
