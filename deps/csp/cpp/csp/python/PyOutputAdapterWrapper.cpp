...
PyObject* PyOutputAdapterWrapper::createAdapter(Creator creator, PyObject* args) {
    ...
    if (!PyArg_ParseTuple(args, "OO!O!", &pyAdapterManager, &PyEngine::PyType, &pyEngine,
                          &PyTuple_Type, &pyArgs))
    ...
    PyOutputAdapterWrapper* object =
        (PyOutputAdapterWrapper*)PyOutputAdapterWrapper::PyType.tp_alloc(
            &PyOutputAdapterWrapper::PyType, 0);
