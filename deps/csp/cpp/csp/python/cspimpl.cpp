...
static PyMethodDef _cspimpl_methods[] = {
    ...
    {"_csp_stop_engine", (PyCFunction)_csp_stop_engine, METH_VARARGS | METH_KEYWORDS,
     "stop engine"},
    ...
    {"set_capture_cpp_backtrace", (PyCFunction)_set_capture_cpp_backtrace, METH_VARARGS,
     "internal"},
    {nullptr}};

static PyModuleDef _cspimpl_module = {PyModuleDef_HEAD_INIT,
                                      "_cspimpl",
                                      "_cspimpl c++ module",
                                      -1,
                                      _cspimpl_methods,
