...
static InputAdapter* numpy_adapter_creator(csp::AdapterManager* manager, PyEngine* pyengine,
    ...
    if (!PyArg_ParseTuple(args, "OO!O!", &type, &PyArray_Type, &pyDatetimes, &PyArray_Type,
                          &pyValues))
