...
INIT_CSP_ENUM(CspType::Type, "UNKNOWN", "BOOL", "INT8", "UINT8", "INT16", "UINT16", "INT32",
              "UINT32", "INT64", "UINT64", "DOUBLE", "DATETIME", "TIMEDELTA", "DATE", "TIME",
              "ENUM", "STRING", "STRUCT", "ARRAY", "DIALECT_GENERIC");
