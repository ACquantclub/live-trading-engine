...
using ArraySubTypeSwitch = PartialSwitchCspType<
    csp::CspType::Type::BOOL, csp::CspType::Type::INT8, csp::CspType::Type::UINT8,
...
struct PartialSwitchCspType<V1, Vs...> {
  ...
  private:
    template <typename F, typename R_T, typename ArraySubTypeSwitchT,
...
using AllCspTypeSwitch = PartialSwitchCspType<
    ...
    csp::CspType::Type::DOUBLE, csp::CspType::Type::DATETIME, csp::CspType::Type::TIMEDELTA,
    csp::CspType::Type::DATE, csp::CspType::Type::TIME, csp::CspType::Type::ENUM,
    csp::CspType::Type::STRING, csp::CspType::Type::STRUCT, csp::CspType::Type::ARRAY,
    csp::CspType::Type::DIALECT_GENERIC>;
using ArithmeticCspTypeSwitch =
    PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::INT8,
                         csp::CspType::Type::UINT8, csp::CspType::Type::INT16,
                         csp::CspType::Type::UINT16, csp::CspType::Type::INT32,
                         csp::CspType::Type::UINT32, csp::CspType::Type::INT64,
                         csp::CspType::Type::UINT64, csp::CspType::Type::DOUBLE>;
using NativeCspTypeSwitch = PartialSwitchCspType<
    csp::CspType::Type::BOOL, csp::CspType::Type::INT8, csp::CspType::Type::UINT8,
    csp::CspType::Type::INT16, csp::CspType::Type::UINT16, csp::CspType::Type::INT32,
    csp::CspType::Type::UINT32, csp::CspType::Type::INT64, csp::CspType::Type::UINT64,
    csp::CspType::Type::DOUBLE, csp::CspType::Type::DATETIME, csp::CspType::Type::TIMEDELTA,
...
/**
 * A class that that defines a single member type "type" to PartialSwitchCspType of all types that
 * can be constructed from T. For example ConstructibleTypeSwitchAux<double> will have its type
 * defined to PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::DOUBLE> since
 * double can be cast to bool or double.
 * @tparam T
 */
template <typename T>
...
struct ConstructibleTypeSwitchAux<bool> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::INT8,
                                      csp::CspType::Type::UINT8, csp::CspType::Type::INT16,
                                      csp::CspType::Type::UINT16, csp::CspType::Type::INT32,
                                      csp::CspType::Type::UINT32, csp::CspType::Type::INT64,
                                      csp::CspType::Type::UINT64, csp::CspType::Type::DOUBLE>;
...
struct ConstructibleTypeSwitchAux<std::int16_t> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::INT16,
                                      csp::CspType::Type::INT32, csp::CspType::Type::INT64,
                                      csp::CspType::Type::DOUBLE>;
};

template <>
struct ConstructibleTypeSwitchAux<std::uint16_t> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::UINT16,
                                      csp::CspType::Type::INT32, csp::CspType::Type::UINT32,
                                      csp::CspType::Type::INT64, csp::CspType::Type::UINT64,
                                      csp::CspType::Type::DOUBLE>;
};
template <>
struct ConstructibleTypeSwitchAux<std::int32_t> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::INT32,
                                      csp::CspType::Type::INT64, csp::CspType::Type::DOUBLE>;
};

template <>
struct ConstructibleTypeSwitchAux<std::uint32_t> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::UINT32,
                                      csp::CspType::Type::INT64, csp::CspType::Type::UINT64,
                                      csp::CspType::Type::DOUBLE>;
};
template <>
struct ConstructibleTypeSwitchAux<std::int64_t> {
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::INT64,
                                      csp::CspType::Type::DOUBLE>;
};
...
struct ConstructibleTypeSwitchAux<std::uint64_t> {
    ...
    using type = PartialSwitchCspType<csp::CspType::Type::BOOL, csp::CspType::Type::UINT64,
                                      csp::CspType::Type::INT64, csp::CspType::Type::DOUBLE>;
};
