...
class ParquetDictBasketOutputWriter : public ParquetWriter {
  public:
    ParquetDictBasketOutputWriter(ParquetOutputAdapterManager* outputAdapterManager,
  ...
  protected:
    SingleColumnParquetOutputHandler* createScalarOutputHandler(CspTypePtr type,
                                                                const std::string& name) override;
    StructParquetOutputHandler* createStructOutputHandler(CspTypePtr type,
                                                          const DictionaryPtr& fieldMap) override;
