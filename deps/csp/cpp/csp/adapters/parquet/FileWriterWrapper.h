...
class FileWriterWrapper {
  public:
    FileWriterWrapper(std::shared_ptr<::arrow::Schema> schema) : m_schema(schema) {
    }
    ...
    void open(const std::string& fileName, const std::string& compression,
  ...
  protected:
    ...
    static std::unique_ptr<arrow::util::Codec> resolveCompressionCodec(
