...
class ParquetOutputAdapterManager final : public csp::AdapterManager {
  public:
    ...
    const char* name() const override {
        return "ParquetOutputAdapterManager";
    }
    ...
    const std::string& getTimestampColumnName() const {
    ...
    bool isWriteArrowBinary() const {
        return m_writeArrowBinary;
    }

    bool isSplitColumnsToFiles() const {
        return m_splitColumnsToFiles;
    }
    ...
    OutputAdapter* getListOutputAdapter(
