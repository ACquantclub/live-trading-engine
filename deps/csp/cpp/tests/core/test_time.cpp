...
TEST(DateTimeTest, test_basic_functionality) {
    ...
    EXPECT_EQ(DateTime(Date(2017, 1, 2), Time(15, 14, 14, 123456)),
              DateTime(2017, 1, 2, 15, 14, 14, 123456));
...
TEST(TimeDeltaTest, test_basic_functionality) {
    ...
    TimeDelta delta2 = TimeDelta::fromNanoseconds(
        (86400 * 3 + 3600 * 4 + 5 * 60 + 15) * NANOS_PER_SECOND + 123456789);
